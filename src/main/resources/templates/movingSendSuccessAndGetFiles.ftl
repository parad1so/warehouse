...
<#if  marker??>
    <div id="container">
        <center>
            ...
            <form action="/window" method="post" enctype="multipart/form-data">
            ...
            <form action="/window/moving/send/report_product" method="post" enctype="multipart/form-data" >
            ...
            <form action="/window/moving/send/report_sklad" method="post" enctype="multipart/form-data">
...
<#else>
    <div style="text-align: center;">
        <div id="container">
            ...
            <br>
            <h2><span style="color: #FF0066">&bull;</span> Данная информация отстутвует в базе данных <span style="color: #FF0066">&bull;</span></h2>
            <form action="/window/moving/send" method="post" enctype="multipart/form-data">
                <input type="submit" value="Назад" style="text-align: center; margin: -4%; padding: 30px 73px;"  id="form_button1"  />
            </form>
        </div>
    </div>
