...
<div id="container">
    <center>
        ...
        <form action="/window/arrival/send/report_product" method="post" enctype="multipart/form-data" >
        ...
        <form action="/window/arrival/send/report_sklad" method="post" enctype="multipart/form-data">
