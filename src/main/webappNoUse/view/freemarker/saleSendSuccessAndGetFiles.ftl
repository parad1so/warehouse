...
<#if  marker??>
    <div id="container">
        <center>
            ...
            <form action="/window/sale/send/report_product" method="post" enctype="multipart/form-data" >
            ...
            <form action="/window/sale/send/report_sklad" method="post" enctype="multipart/form-data">
