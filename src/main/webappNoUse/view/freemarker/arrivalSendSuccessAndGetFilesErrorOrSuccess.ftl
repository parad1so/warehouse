...
<div id="container">
        ...
        <center>
            ...
            <form action="/window/arrival/send/report_product" method="post">
            ...
            <form action="/window/arrival/send/report_sklad" method="post">
            ...
            <#else>
                <div style="text-align: center;">
                    <div id="container">
                        ...
                        <form action="/window/arrival/" method="post" enctype="multipart/form-data">
                            <input type="submit" value="Назад" style="text-align: center; margin: -4%; padding: 30px 73px;"  id="form_button1"  />
                        </form>
                    </div>
                </div>
