...
<div id="container">
    ...
    <center>
        ...
        <form action="/window/moving/view_all_documents" method="post" enctype="multipart/form-data">
        ...
        <form action="/window/moving/view_document" method="post"  enctype="multipart/form-data">
