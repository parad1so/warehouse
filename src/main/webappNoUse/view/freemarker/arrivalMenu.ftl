...
<div id="container">
    ...
    <center>
        ...
        <form action="/window/arrival/view_all_documents" method="post" enctype="multipart/form-data">
            <input type="file" value="Добавить"  style="text-align: center; margin-top: 1%; padding: 30px 55px;" id="form_button"  multiple="multiple"  name="fileName1" required />
        ...
        <form action="/window/arrival/view_document" method="post"  enctype="multipart/form-data">
